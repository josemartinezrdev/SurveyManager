...
CREATE TABLE users_roles (
    ...
    CONSTRAINT fk_users_roles_users FOREIGN KEY (role_id) REFERENCES roles (id)
);
...
CREATE TABLE chapter (
    ...
    CONSTRAINT fk_chapter_surveys FOREIGN KEY (survey_id) REFERENCES surveys
);
...
CREATE TABLE questions (
    ...
    CONSTRAINT fk_questions_chapter FOREIGN KEY (chapter_id) REFERENCES chapter
);
...
CREATE TABLE response_options (
    ...
    categorycatalog_id INT(8),
    question_id INT(8),

    -- Esta es la foranea que va a si misma.
    parentresponse_id INT(8),

    CONSTRAINT pk_id_reponse_options PRIMARY KEY (id),
...
CREATE TABLE subresponse_options (
    ...
    created_at TIMESTAMP(6),
    updated_at TIMESTAMP(6),
    commponent_html VARCHAR(255),
    subresponse_text VARCHAR(255),

    responseoptions_id INT(8),
...
CREATE TABLE response_question (
    ...
    CONSTRAINT fk_res_quest_res_opts FOREIGN KEY (response_options) REFERENCES response_options (id),
